...
class DAC:
    ...
    def __init__(self, host, bp):
        ...
        try:
            ...
            if self.last_broadcast.sw_revision < 2:
                ...
                self.firmware_string = self.read(32).replace(b"\x00", b" ").strip()
    ...
    def play_point_stream(self, stream, point_rate=30000, buf_size=1799):
        ...
        while True:
            # Determine how many points we can write
